...
def say_my_name(first_name, last_name=""):
    ...
    - last_name (str, optional): The last name to be included in the formatted string. Default is an empty string.

    Raises:
    - TypeError: If 'first_name' or 'last_name' is not a string.

    Returns:
    - None: The function prints the formatted string but does not return any value.
    """
